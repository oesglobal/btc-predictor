...
st.subheader("📊 Live Candlestick Chart (15s Interval)")
...
# ---------------------- Footer ----------------------
st.markdown("---")
st.markdown("✅ Using [Binance](https://www.binance.com/) API for real-time data.\nAuto-refresh every 15 seconds. Visit: `predict.oeslink.one`")
